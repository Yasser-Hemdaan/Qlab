...
const Examinations = ({ ExaminationsNumber }) => {
  ...
  return (
    <div className={`${styles.examinations}`}>
        ...
        <div className={`${styles.examinationsBody} sectionBody mx-auto pt-5`}>
          ...
          <div
            className={`${styles.examinationsCardsContainer} mx-auto p-4 mb-4`}
          >
                    ...
                    <div className={`${styles.cardBody} m-4`}>
                      ...
                      <div>
                        <p className={`${styles.price}`}>
                          <span>
                            {t(
                              `home.examinations.examinationsCards.priceTitle`
                            )}
                          </span>{" "}
                          <span>
                            {t(
